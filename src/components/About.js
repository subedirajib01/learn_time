...
// const [btnText, setbtnText] = useState("Enable light button");
...
return (
    ...
    <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
        ...
        TextUtils gives you a way to analyze your text qquickly and efficiently. Be it word count, character count.
        </div>
    </div>
    </div>
    <div className="accordion-item">
